...
class fileSearcherFlatSpec extends FlatSpec {
  ...
  "FilterChecker passed a file with content that 3 matches the filter" should
  ...
  "FilterChecker passed when no file with content that 0 matches the filter" should
    "return that the match succeeded" in {
